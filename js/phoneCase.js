...
testcollage= function (opts) {
	...
	function createhtmlbody() {
        ...
        htmlstr += "				<h3 id=headingbar>Phone Case Designer<\/h3>";
        htmlstr += "                <select id=phonelist name=phonelist><\/select>";
	...
	function createpage() {
		...
		page.canvas.style.backgroundColor = '#BBB';
    ...
    function addPhoneCaseOptions(){
		console.log("adding phone list");
        $('#phonelist').append($('<option>', {
            value: "images/phones/nokia72.png",
            text: 'Nokia 7.2'
		}));
