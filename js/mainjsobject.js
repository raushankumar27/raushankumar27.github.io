...
testcollage__c = function (opts) {
	var PAGE_DATA = {
		...
		savetype:null,
		library: {
			raphael: "https://cdnjs.cloudflare.com/ajax/libs/raphael/2.2.1/raphael.min.js",
			jspdf: "https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.2.61/jspdf.min.js"
		}
	}
	var PAGE_OPTIONS = {
		settings: {
